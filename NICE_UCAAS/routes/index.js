...
router.get('/messages', (req, res) => {
    ...
    var options = {
        method: 'GET',
        url: 'https://api.zoom.us/v2/chat/users/uvE-J3tgQfmGi1DrQ3mJsg/messages?page_size=10',
        qs: {page_size: '10', to_contact: 'kulkarni.pranav123@gmail.com', date: '2020-11-21'},
        headers: {authorization:"Bearer "+ authcode}
      };
      console.log(authcode);
        request(options, (error, response, body) => {
...
router.get('/sendmessage', (req, res) => {
    ...
    var options = {
        method: 'POST',
        url: 'https://api.zoom.us/v2/chat/users/{userID}/messages',//Enter UserID
        headers: {'content-type': 'application/json', authorization: "Bearer "+ authcode},
        body: {message: 'Test from Node2', to_contact: 'kulkarni.pranav123@gmail.com'},
        json: true
      };
      console.log(authcode);
        request(options, (error, response, body) => {
